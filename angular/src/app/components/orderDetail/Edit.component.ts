          ...
          <form ngNativeValidate method="post" (submit)="edit()">
            <div class="row">
              ...
              <div class="form-group col-md-6 col-lg-4">
                ...
                <select id="order_detail_product_id" name="ProductId" class="form-control form-control-sm" [(ngModel)]="orderDetail.ProductId" required>
                  <option *ngFor="let product of products" value="{{product.Id}}" [selected]="orderDetail != null && orderDetail.ProductId == product.Id">{{product.Name}}</option>
                </select>
