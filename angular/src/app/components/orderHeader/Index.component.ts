            ...
            <table class="table table-sm table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th class="{{util.getSortClass('CustomerName') + ' d-none d-md-table-cell'}}"><a (click)="util.goto($event)" href="{{util.getLink(this.paging,'sort','CustomerName')}}">Customer</a></th>
                  <th class="{{util.getSortClass('OrderDate')}}"><a (click)="util.goto($event)" href="{{util.getLink(this.paging,'sort','OrderDate')}}">Order Date</a></th>
                  <th>Actions</th>
                </tr>
              </thead>
              <tbody>
