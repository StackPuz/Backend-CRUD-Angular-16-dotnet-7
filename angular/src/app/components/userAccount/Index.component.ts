            ...
            <table class="table table-sm table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th class="{{util.getSortClass('Email') + ' d-none d-md-table-cell'}}"><a (click)="util.goto($event)" href="{{util.getLink(this.paging,'sort','Email')}}">Email</a></th>
                  <th class="{{util.getSortClass('Active')}}"><a (click)="util.goto($event)" href="{{util.getLink(this.paging,'sort','Active')}}">Active</a></th>
                  <th>Actions</th>
                </tr>
              </thead>
              <tbody>
